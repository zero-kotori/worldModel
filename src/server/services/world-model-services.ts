...
const evidenceLinksSchema = z.array(evidenceLinkSchema).min(1);
const editableEvidenceLinksSchema = z.array(evidenceLinkSchema);
...
const disconnectEvidenceHypothesisSchema = z.object({
  hypothesisId: z.string().min(1)
});
